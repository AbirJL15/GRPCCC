...
public final class MessagingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.Messaging.TextMessage,
      org.example.Messaging.SendMessageResponse> getSendMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendMessage",
      requestType = org.example.Messaging.TextMessage.class,
      responseType = org.example.Messaging.SendMessageResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.example.Messaging.TextMessage,
      org.example.Messaging.SendMessageResponse> getSendMessageMethod() {
    io.grpc.MethodDescriptor<org.example.Messaging.TextMessage, org.example.Messaging.SendMessageResponse> getSendMessageMethod;
      ...
      synchronized (MessagingServiceGrpc.class) {
        if ((getSendMessageMethod = MessagingServiceGrpc.getSendMessageMethod) == null) {
          MessagingServiceGrpc.getSendMessageMethod = getSendMessageMethod = 
              io.grpc.MethodDescriptor.<org.example.Messaging.TextMessage, org.example.Messaging.SendMessageResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "MessagingService", "SendMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.Messaging.TextMessage.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.Messaging.GetReceivedMessagesRequest,
      org.example.Messaging.TextMessage> getGetReceivedMessagesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetReceivedMessages",
      requestType = org.example.Messaging.GetReceivedMessagesRequest.class,
      responseType = org.example.Messaging.TextMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<org.example.Messaging.GetReceivedMessagesRequest,
      org.example.Messaging.TextMessage> getGetReceivedMessagesMethod() {
    io.grpc.MethodDescriptor<org.example.Messaging.GetReceivedMessagesRequest, org.example.Messaging.TextMessage> getGetReceivedMessagesMethod;
      ...
      synchronized (MessagingServiceGrpc.class) {
        if ((getGetReceivedMessagesMethod = MessagingServiceGrpc.getGetReceivedMessagesMethod) == null) {
          MessagingServiceGrpc.getGetReceivedMessagesMethod = getGetReceivedMessagesMethod = 
              io.grpc.MethodDescriptor.<org.example.Messaging.GetReceivedMessagesRequest, org.example.Messaging.TextMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "MessagingService", "GetReceivedMessages"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.Messaging.GetReceivedMessagesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.Messaging.TextMessage.getDefaultInstance()))
  ...
  public static abstract class MessagingServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sendMessage(org.example.Messaging.TextMessage request,
     ...
     * </pre>
     */
    public void getReceivedMessages(org.example.Messaging.GetReceivedMessagesRequest request,
        io.grpc.stub.StreamObserver<org.example.Messaging.TextMessage> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.example.Messaging.TextMessage,
          ...
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                org.example.Messaging.GetReceivedMessagesRequest,
                org.example.Messaging.TextMessage>(
  ...
  public static final class MessagingServiceBlockingStub extends io.grpc.stub.AbstractStub<MessagingServiceBlockingStub> {
     ...
     * </pre>
     */
    public org.example.Messaging.SendMessageResponse sendMessage(org.example.Messaging.TextMessage request) {
     ...
     * </pre>
     */
    public java.util.Iterator<org.example.Messaging.TextMessage> getReceivedMessages(
        org.example.Messaging.GetReceivedMessagesRequest request) {
  ...
  public static final class MessagingServiceFutureStub extends io.grpc.stub.AbstractStub<MessagingServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<org.example.Messaging.SendMessageResponse> sendMessage(
        org.example.Messaging.TextMessage request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_MESSAGE:
          serviceImpl.sendMessage((org.example.Messaging.TextMessage) request,
              (io.grpc.stub.StreamObserver<org.example.Messaging.SendMessageResponse>) responseObserver);
          break;
        case METHODID_GET_RECEIVED_MESSAGES:
          serviceImpl.getReceivedMessages((org.example.Messaging.GetReceivedMessagesRequest) request,
              (io.grpc.stub.StreamObserver<org.example.Messaging.TextMessage>) responseObserver);
          break;
        default:
